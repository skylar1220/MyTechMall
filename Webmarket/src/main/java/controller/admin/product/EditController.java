...
@Override
	...
	String ogProductId = request.getParameter("ogProductId");	 
	...
	String isOpen= request.getParameter("open");	// check: true or x: null
	Boolean pub = false;
	if(isOpen != null)
		pub = true;
	...
	productService.updateProduct(ogProductId, product);
